            ...
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('post.login') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control" placeholder="Email" @if (!empty($_COOKIE['email']))
                         value="{{ $_COOKIE['email']; }}"
                        @endif>
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password" class="form-control" placeholder="Password" @if (!empty($_COOKIE['password']))
